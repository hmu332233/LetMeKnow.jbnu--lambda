...
function parseTable($, $table, { place }) {
  ...
  return {
    ...
    dinner: [
      { place, week: '월', time: '석식', category: '백반', menus: menus[6] },
      { place, week: '화', time: '석식', category: '백반', menus: menus[7] },
      { place, week: '수', time: '석식', category: '백반', menus: menus[8] },
      { place, week: '목', time: '석식', category: '백반', menus: menus[9] },
      { place, week: '금', time: '석식', category: '백반', menus: menus[10] },
    ],
  }
}
